              ...
              >
                {(provided) => (
                  ...
                  >
                    <div
                      className={cn(
                        "flex justify-between gap-x-4 w-full px-2 py-3 border-r-slate-200 hover:bg-slate-300 rounded-l-md transition ",
                        chapter.isPublished &&
                    ...
                    >
                      ...
                      <div className="ml-auto pr-2 flex items-center gap-x-2">
                        ...
                        <Pencil
                          ...
                          className="w-r h-4 cursor-pointer  hover:opacity-75 transition"
                        />
                      </div>
                    </div>
                  </div>
